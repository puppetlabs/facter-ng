  ...
  module Util
    class Collection
      ...
      def external_facts
        ...
        @external_facts = Facter::Utils.deep_copy(@facts).delete_if { |k, _| facts_before_load.key?(k) }
      end
      ...
      def custom_facts
        ...
        @custom_facts = Facter::Utils.deep_copy(@facts).delete_if { |k, _| facts_before_load.key?(k) }
      end
