...
module LegacyFacter
  ...
  #
  #       $ git describe > lib/custom_facts/VERSION
  #       $ ruby -r custom_facts -e 'puts Facter.version'
  #       1.6.14-6-g66f2c99
  #
  # @api public
  #
  ...
  def self.read_version_file(path)
    Facter::Resolvers::Utils::FileHelper.safe_read(path).chomp
  end
