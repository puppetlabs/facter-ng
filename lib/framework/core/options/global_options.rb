...
module Facter
  module GlobalOptions
    ...
    def augment_global(global_conf)
      ...
      @options[:no_external_facts] = !global_conf['external-facts'] unless @options[:no_external_facts]
      @options[:no_custom_facts] = !global_conf['custom-facts'] unless @options[:no_custom_facts]
