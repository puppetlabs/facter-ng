...
describe 'Solaris ZFS' do
  context '#call_the_resolver' do
    it 'returns zfs_version fact' do
      ...
      allow(Facter::Resolvers::SolarisZFS).to receive(:resolve).with(:zfs_version).and_return('6')
    ...
    it 'returns zfs_featurenumbers fact' do
      ...
      allow(Facter::Resolvers::SolarisZFS).to receive(:resolve).with(:zfs_featurenumbers).and_return('1, 2, 3, 4, 5')
