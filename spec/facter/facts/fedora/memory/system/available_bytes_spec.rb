...
describe 'Fedora MemorySystemAvailableBytes' do
  context '#call_the_resolver' do
    it 'returns a fact' do
      ...
      allow(Facter::ResolvedFact).to receive(:new).with('memory.system.available_bytes', 'value').and_return(expected_fact)

      fact = Facter::Fedora::MemorySystemAvailableBytes.new
